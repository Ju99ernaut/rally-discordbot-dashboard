<template>
  <div
    class="min-h-screen min-w-full bg-gray-100 dark:bg-gray-900 flex flex-col justify-center p-10"
  >
    <div
      ...
      <div class="relative bg-white dark:bg-gray-800 shadow-lg sm:rounded-3xl">
        ...
        <div class="px-20 py-6">
          ...
          <div class="lg:2/6 xl:w-2/4 mt-20 lg:mt-40 lg:ml-16 text-left">
            <div
              class="text-6xl font-semibold text-gray-900 dark:text-gray-200 leading-none"
            >
              {{ $t("landing.main") }}
            </div>
            <div
            ...
            >
              <a class="flex" :href="botUrl" target="_blank">
                ...
                <span>{{ $t("landing.addTo") }} Discord</span>
              </a>
            </button>
          </div>
