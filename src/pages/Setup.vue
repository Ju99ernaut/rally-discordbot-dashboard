  ...
  <div id="setup">
    ...
    >
      <div class="flex items-center">
        ...
        <span>Setup channels on discord</span>
      </div>
      <span>Let's go &RightArrow;</span>
    </a>
    ...
    >
      <div class="flex items-center">
        ...
        <span>Setup roles on discord</span>
      </div>
      <span>Let's go &RightArrow;</span>
    </a>
    ...
    >
      <div class="flex items-center">
        ...
        <span>Setup permissions on discord</span>
      </div>
      <span>Let's go &RightArrow;</span>
    </a>
    ...
    <div class="flex flex-wrap -mx-3">
      <div class="w-full xl:w-1/2 px-3">
        ...
        >
          <p class="text-xl mb-4">Channel Mappings</p>
      ...
      <div class="w-full xl:w-1/2 px-3">
        <div
          class="w-full bg-white rounded-lg shadow-md dark:bg-gray-800 p-4 mb-8 xl:mb-0"
        >
          <p class="text-xl mb-4">Role Mappings</p>
          <table class="w-full whitespace-no-wrap">
            <thead>
              <tr
                class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800"
